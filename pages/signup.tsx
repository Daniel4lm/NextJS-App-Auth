...
export default function Signup(props) {
    ...
    useEffect(() => {
        if (collectedData) {
            console.log('Singing up ....', collectedData);
            loginHandler();
        }
    ...
    const loginHandler = async () => {
        ...
        try {
            const logRes = await fetch(`${baseApiUrl}/auth/signup`,
                {
                    method: 'POST',
                    headers: {
    ...
    const onSubmitForm = (data) => {
        ...
        setCollectedData({ ...data, ...{ createdAt: DateTime.now().toFormat('yyyy-LL-dd HH:mm:ss') } });
    }
    ...
    return (
        <>
            <form className={style.loginForm} autoComplete="off" onSubmit={handleSubmit(onSubmitForm)}>
                ...
                <label className={style.loginLabel} htmlFor="user_name">E-mail</label>
                <input
                    ...
                    ref={(e) => {
                        ...
                        register(e, {
                            ...
                            minLength: {
                                value: 5,
                                message: "User name contains min 5 characters!",
                            },
                            pattern: {
                                value: /^[A-Za-z]+$/gi,
                                message: "User name can't contain numbers. Invalid format!",
                            },
                        });
                    }}
                    ...
                    name="user_name"
                />
                <InputError error={errors.user_name} />
                ...
                <input className={style.inputForm} type="submit" value="Sign Up"></input>
